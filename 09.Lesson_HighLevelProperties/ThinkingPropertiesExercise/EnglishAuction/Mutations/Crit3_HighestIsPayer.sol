...
contract EnglishAuction {
    ...
    function _bid(address bidder, address payer, uint amount) internal {
        ...
        // Crit Bug here - the highestBidder should be Bidder. Using bidFor() we can reset the highestBid (and the beneficier!).
        uint256 new_amount = bids[bidder] + amount;
        require(new_amount > previousBid);
        bids[bidder] = new_amount;
        highestBidder = payer;
