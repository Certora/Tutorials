 ...
 *
 * - A PENDING meeting can be started by anybody if the start time has arrived (the meeting's status 
 * changes to STARTED) or be canceled (changes to CANCELLED) by its owner. A meeting that has already
