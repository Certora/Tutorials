...
invariant indexInjective(address token1, address token2)
    ...
    /*  running the invariant gets a violation where the reserveCount index is not empty so lets prove that and then we can assume that indexLessThanCount holds. However this is also not enought 
    */
    {
